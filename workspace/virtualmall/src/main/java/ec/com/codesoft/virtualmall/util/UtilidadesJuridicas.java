...
public class UtilidadesJuridicas {
    ...
    /**
     * Metodo que me permite validar cualquiera de las identificaciones
     * @param identificacion
     * @return 
     */
    public static Boolean validarIdentificaciones(String identificacion) 
    {
        if(identificacion.length()==13)
        {
            return validarTodosRuc(identificacion);
